/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a74604bc68afbcc2964abcdc0c6af094)
// Runtime types generated with workerd@1.20260911.1 2025-09-02 
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	DATABASE_URL: string;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	hyperdrive_user: string;
}
